...
export default function Navbar({ brandName, logoUrl, githubUrl }: NavbarProps) {
  return (
      ...
      <div className="flex items-center gap-4">
        {githubUrl && (
          <a
            ...
            className="flex items-center gap-1.5 text-muted transition-colors duration-200 hover:text-foreground"

...
export default function Hero({ headline, tagline, description, githubUrl, children }: HeroProps) {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-24 pb-16 text-center">
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <p
          className="animate-fade-up mx-auto max-w-xl text-base leading-relaxed text-muted font-body sm:text-lg"

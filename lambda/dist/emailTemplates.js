...
function generateVerificationEmail(verificationUrl, brandName) {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:40px auto;background-color:#ffffff;border-radius:8px;overflow:hidden;">
    <tr>
      <td style="padding:40px 32px;text-align:center;">
        ...
        <a href="${verificationUrl}" style="display:inline-block;padding:12px 32px;background-color:#18181b;color:#ffffff;text-decoration:none;border-radius:6px;font-size:15px;font-weight:500;">
          Verify Email
        </a>
        <p style="margin:32px 0 0;font-size:13px;line-height:1.5;color:#a1a1aa;">
          This link expires in 24 hours. If you didn't sign up for ${brandName}, you can ignore this email.
        </p>
